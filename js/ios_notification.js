function onNotificationAPN (event) {
	...
	$.ajax({
		...
		success: function(data) {
			...
			$(".notification-facebook-share").attr("onclick","$.mobile.loading('show');window.plugins.socialsharing.shareViaFacebookWithPasteMessageHint('Use Coupon code :"+notificationCoupon.ios_single_coupon_code+" And get "+notificationCoupon.ios_single_coupon_desc+" at "+notificationCoupon.ios_single_coupon_merchant+"', 'http://nearbybestdeals.com/wp-content/themes/enfold/images/layout/logo.jpg', 'http://maps.google.com/maps?q=loc:"+notificationCoupon.ios_single_coupon_lat+","+notificationCoupon.ios_single_coupon_lon+"', 'Paste it!', function() {$.mobile.loading('hide');}, function(errormsg){alert(errormsg);$.mobile.loading('hide');})");
